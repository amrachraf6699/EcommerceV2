...
class StoreProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'variants.*.name' => ['nullable', 'required_with:variants.*.price,variants.*.stock_quantity,variants.*.compare_at_price', 'string', 'max:255'],
            'variants.*.price' => ['nullable', 'required_with:variants.*.name,variants.*.stock_quantity', 'numeric', 'min:0'],
            'variants.*.compare_at_price' => ['nullable', 'numeric', 'min:0'],
            'variants.*.stock_quantity' => ['nullable', 'required_with:variants.*.name,variants.*.price', 'integer', 'min:0'],
