...
@section('content')
    <div class="admin-card space-y-6" data-admin-tabs data-product-editor>
        ...
        <section class="admin-tab-panel hidden" data-admin-tab-panel="variants" id="productVariantsPanel">
